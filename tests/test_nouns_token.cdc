...
pub fun setup() {
    blockchain.useConfiguration(Test.Configuration({
        "NounsDescriptor": admin.address,
        "NounsToken": admin.address
    }))

    var code = Test.readFile("../contracts/NounsDescriptor.cdc")
    ...
    code = Test.readFile("../contracts/NounsToken.cdc")
...
pub fun testContractInitializedEventEmitted() {
    let typ = CompositeType("A.01cf0e2f2f715450.NounsToken.ContractInitialized")!
...
//     let typ = CompositeType("A.01cf0e2f2f715450.NounsToken.Deposit")!
//     Test.assertEqual(1, blockchain.eventsOfType(typ).length)
...
//     var typ = CompositeType("A.01cf0e2f2f715450.NounsToken.Withdraw")!
//     Test.assertEqual(1, blockchain.eventsOfType(typ).length)

//     typ = CompositeType("A.01cf0e2f2f715450.NounsToken.Deposit")!
...
//     Test.assertEqual(/storage/NounsTokenCollection, storagePath)
// }
...
// pub fun testGetNounsTokenViews() {
...
// pub fun testResolveNounsTokenViews() {
