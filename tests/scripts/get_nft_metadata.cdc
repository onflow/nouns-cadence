...
pub fun main(address: Address, id: UInt64): Bool {
    ...
    let collection = account
        .getCapability(NounsToken.CollectionPublicPath)
        .borrow<&{NounsToken.NounsTokenCollectionPublic}>()
        ?? panic("Could not borrow a reference to the collection")

    let nft = collection.borrowNounsToken(id: id)!
    ...
    assert("A.01cf0e2f2f715450.NounsToken.NFT" == nftMetadata.type)
    ...
    assert(/public/NounsTokenCollection == nftMetadata.collectionPublicPath)
    assert(/storage/NounsTokenCollection == nftMetadata.collectionStoragePath)
    assert(/private/NounsTokenCollection == nftMetadata.collectionProviderPath)
    assert("&A.01cf0e2f2f715450.NounsToken.Collection{A.01cf0e2f2f715450.NounsToken.NounsTokenCollectionPublic}" == nftMetadata.collectionPublic)
    assert("&A.01cf0e2f2f715450.NounsToken.Collection{A.01cf0e2f2f715450.NounsToken.NounsTokenCollectionPublic,A.f8d6e0586b0a20c7.NonFungibleToken.CollectionPublic,A.f8d6e0586b0a20c7.NonFungibleToken.Receiver,A.f8d6e0586b0a20c7.MetadataViews.ResolverCollection}" == nftMetadata.collectionPublicLinkedType)
    assert("&A.01cf0e2f2f715450.NounsToken.Collection{A.01cf0e2f2f715450.NounsToken.NounsTokenCollectionPublic,A.f8d6e0586b0a20c7.NonFungibleToken.CollectionPublic,A.f8d6e0586b0a20c7.NonFungibleToken.Provider,A.f8d6e0586b0a20c7.MetadataViews.ResolverCollection}" == nftMetadata.collectionProviderLinkedType)
