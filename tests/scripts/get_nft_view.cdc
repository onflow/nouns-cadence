...
pub fun main(address: Address, id: UInt64): Bool {
    ...
    assert(/public/NounsTokenCollection == nftViewResult.collectionPublicPath)
    assert(/storage/NounsTokenCollection == nftViewResult.collectionStoragePath)
    assert(/private/NounsTokenCollection == nftViewResult.collectionProviderPath)
    assert("&A.01cf0e2f2f715450.NounsToken.Collection{A.01cf0e2f2f715450.NounsToken.NounsTokenCollectionPublic}" == nftViewResult.collectionPublic)
    assert("&A.01cf0e2f2f715450.NounsToken.Collection{A.01cf0e2f2f715450.NounsToken.NounsTokenCollectionPublic,A.f8d6e0586b0a20c7.NonFungibleToken.CollectionPublic,A.f8d6e0586b0a20c7.NonFungibleToken.Receiver,A.f8d6e0586b0a20c7.MetadataViews.ResolverCollection}" == nftViewResult.collectionPublicLinkedType)
    assert("&A.01cf0e2f2f715450.NounsToken.Collection{A.01cf0e2f2f715450.NounsToken.NounsTokenCollectionPublic,A.f8d6e0586b0a20c7.NonFungibleToken.CollectionPublic,A.f8d6e0586b0a20c7.NonFungibleToken.Provider,A.f8d6e0586b0a20c7.MetadataViews.ResolverCollection}" == nftViewResult.collectionProviderLinkedType)
